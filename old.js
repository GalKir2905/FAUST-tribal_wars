...
// Р—Р°РіСЂСѓР¶Р°РµРј СЃРѕС…СЂР°РЅРµРЅРЅС‹Рµ farmCoords
var savedFarmCoords = localStorage.getItem("farmCoords");
if (savedFarmCoords) {
    document.getElementById('farmCoords').value = savedFarmCoords;
}

// Р’РµС€Р°РµРј РѕР±СЂР°Р±РѕС‚С‡РёРє РЅР° РєРЅРѕРїРєСѓ Save
...
function calculateHaulCategories(data) {
    ...
    if (data.has_rally_point == true) {
        ...
        // ==== РРЎРџР РђР’Р›Р•РќРќР«Р™ РљРћР”: РџСЂРѕРІРµСЂСЏРµРј РїРѕ localStorage ====
        var savedFarmCoords = localStorage.getItem("farmCoords");
        var farmCoords = [];
        ...
        // ==== РљРћРќР•Р¦ РРЎРџР РђР’Р›Р•РќРќРћР“Рћ РљРћР”Рђ ====
...
// Р¤СѓРЅРєС†РёСЏ РѕС‡РёСЃС‚РєРё РєРѕРѕСЂРґРёРЅР°С‚
