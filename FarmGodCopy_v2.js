...
window.FarmGod.Translation = (function () {
  const msg = {
    ru_RU: {
      missingFeatures:
        'Скрипт требует премиум аккаунт и помощник по фарму!',
      options: {
        title: 'Настройки FarmGod',
        warning:
          '<b>Внимание:</b><br>- Убедитесь, что A установлен как ваш стандартный микрофарм, а B как более крупный микрофарм<br>- Убедитесь, что фильтры фарма правильно настроены перед использованием скрипта',
        filterImage:
          'https://higamy.github.io/TW/Scripts/Assets/farmGodFilters.png',
        group: 'Отправлять фармы из группы:',
        distance: 'Максимальное расстояние в полях для фармов:',
        time: 'Интервал между фармами в минутах:',
        losses: 'Отправлять фарм в деревни с частичными потерями:',
        maxloot: 'Отправлять фарм B если последняя добыча была полной:',
        newbarbs: 'Добавлять новые варварские деревни для фарма:',
        button: 'Планировать фармы',
      },
      table: {
        noFarmsPlanned:
          'С указанными настройками невозможно отправить фармы.',
        origin: 'Откуда',
        target: 'Куда',
        fields: 'Поля',
        farm: 'Фарм',
      ...
      messages: {
        villageChanged: 'Успешно изменена деревня!',
        villageError:
          'Все фармы для текущей деревни уже отправлены!',
        sendError: 'Ошибка: фарм не отправлен!',
      },
    },
    nl_NL: {
      missingFeatures:
    ...
    hu_HU: {
      ...
      options: {
        ...
        warning:
          '<b>Figyelem:</b><br>- Bizonyosodj meg rÃ³la, hogy az "A" sablon az alapÃ©rtelmezett Ã©s a "B" egy nagyobb mennyisÃ©gÅ± mikrÃ³-farm<br>- Bizonyosodj meg rÃ³la, hogy a farm-filterek megfelelÅ‘en vannak beÃ¡llÃtva mielÅ‘tt hasznÃ¡lod a sctiptet',
        filterImage:
