...
tsalkapone_trans.italian= { 
     ...
     notification:"Notifiche da",
        ...
        info36:"Bandiere",
        info37:"Lo script mostrerà le bandiere assegnate a ciascuno dei vostri villaggi sulla mappa utilizzando il colore della bandiera a grandezza naturale come colore di sfondo e il tipo di bandiere come testo, vicino ciascun villo.<br><br>Si un paese non dispone di una bandiera, sarà contrassegnato con il seguente colore",
...
tsalkapone_trans.russian= { 
	 ...
	 instructions:"Инструкции и переменные для балансировщика ресурсов",
	 notification:"Уведомление от",
         selected_one:"Текущий выбранный язык",
         available:"Доступные языки",
		 button_list:"Список кнопок",
		 add_info:"Нажмите, чтобы прочитать больше о дополнительной информации выбранного шаблона",
		 lang_sel:"Нажмите, чтобы изменить выбранный язык",
		efarmogi:"Нажмите, чтобы применить настройки выбранного шаблона",
		diagrafi:"Нажмите, чтобы удалить все сохраненные данные с карты",
		protupo:"Нажмите, чтобы выбрать шаблон настроек",
		sets:"Дополнительные настройки",
		vals:"Значение",
		set1:"Выберите настройку шаблона для отображения времени",
		set2:"Выберите метод расчета уровня защиты",
		s1:"Дни:Часы",
		s2:"Часы:Минуты",
		s3:"Население войск",
		s4:"Очки OD войск",
		s5:"Включить/Выключить сохранение данных при перемещении курсора по карте",
		s6:"Включить отображение текущих очков вместо времени",
		p0:"Выбрать шаблон",
		p1:"Рост деревни",
		p2:"Завоевания",
		p3:"Фарминг & Команды",
		...
		p6:"Бонусные деревни",
		p7:"Уровень атаки",
		vil_time:"Возраст данных текущей деревни",
		month:"мес",
		days:"дн",
		noflag:"Нет флага",
		hour:"ч",
		...
		info_1:"Выберите доступный метод отображения возраста данных каждой деревни на Карте.",
		info_2:"Включите эту опцию для сохранения данных при перемещении курсора по Карте.<br><br>Настоятельно рекомендуется не включать эту опцию при первой активации шаблона.<br><br>Активируйте шаблон и после того, как заметите рост деревень, включите ее для обновления данных каждой деревни.",
		info_3:"В случае включения этой опции возраст данных каждой деревни будет заменен на ее текущие очки.<br><br>Ниже этой таблицы вы будете уведомлены о возрасте данных вашей текущей деревни.",
		info_4:"Выберите доступный метод расчета уровня защиты/атаки каждой из ваших деревень.<br><b><u>Население войск:</u></b><br>Выберите эту опцию для расчета уровня защиты/атаки в соответствии с населением войск в деревне (21.000 населения считаются как 1 деревня для защиты, 19.000 населения считаются как 1 деревня для атаки).<br><b><u>Очки OD войск:</u></b><br>Выберите эту опцию для расчета уровня защиты на основе очков ODA войск (85.000 очков считаются как 1 деревня) и уровня атаки на основе очков ODD войск (72.000 очков считаются как 1 деревня).",
		info1:"Добавить добычу, тип отчета и время последней атаки на карту",
		info2:"Каждая деревня, которую вы атаковали и ваши юниты вернулись с полной добычей, будет отмечена изображением полной добычи",
		info3:"Каждая деревня, которую вы атаковали и ваши юниты вернулись с частичной добычей, будет показана с изображением частичной добычи",
		info4:"Для каждой деревни дополнительное информационное окно карты будет окрашено в соответствии с <b>ВАШИМ</b> последним типом отчета. Цвета представляют тип отчета, как известно в игре. Остальные цвета являются исключением из правила",
		info5:"Исключения",
		info6:"Отчет с полными потерями, но одно или несколько вражеских зданий было разрушено",
		info7:"Темно-оранжевый цвет",
		info8:"Отчет с полными потерями, но успешной разведкой",
		info9:"Темно-пурпурный цвет",
		info10:"Время",
		info11:"Если деревня была последний раз атакована вами более 30 дней назад, будет показан оставшийся текст",
		info12:"Если деревня была последний раз атакована вами менее 30 дней и более 2 дней назад, будет показан оставшийся текст",
		info13:"дней назад вы последний раз атаковали деревню",
		info14:"Если деревня была последний раз атакована вами менее 2 дней назад, но НЕ в тот же день, будет показан оставшийся текст",
		info15:"Если деревня была последний раз атакована вами в тот же день, то <b>час</b> вашей последней атаки будет показан в дополнительной информации. Например",
		info16:"ВНИМАНИЕ",
		info17:"Дополнительная информация карты представляет информацию из ВАШИХ СОБСТВЕННЫХ отчетов, а не отчетов союзников или друзей. Также, эта информация поступает из существующих отчетов, а не из удаленных отчетов",
		info18:"Этот скрипт работает ТОЛЬКО с активным премиум аккаунтом",
		info19:"Если возникли какие-либо ошибки скрипта, или у вас есть идеи или предложения, вы можете связаться с",
		info20:"Добыча",
		info21:"Тип отчета",
		info22:"Показать рост на карте",
		info23:"Возраст данных",
		info24:"Возраст данных (и его форма) для каждой деревни на Карте определяется пользователем. Вы можете выбрать, сохранять ли данные каждой деревни или нет. Вы можете использовать эту возможность для своих собственных целей. <br><br>Если скрипт не найдет сохраненных данных для деревни, он пометит деревню следующим цветом",
		info25:"Рост",
		info26:"Скрипт рассчитает разницу между сохраненными очками и текущими очками каждой деревни и отобразит их на Карте. Цвета ниже представляют тип разницы в очках",
		info27:"Нет разницы",
		info28:"Очки увеличились",
		info29:"Очки уменьшились",
		info30:"Показать завоевания на карте",
		info31:"Цвета ниже представляют, изменился ли владелец деревни (на основе сохраненных данных каждой деревни)",
		info32:"Владелец деревни изменился",
		info33:"Владелец деревни не изменился",
		info34:"Завоевания",
		info35:"Показать флаги на карте",
		info36:"Флаги",
		info37:"Скрипт покажет флаги, назначенные каждой из ваших деревень на Карте, используя цвет размера флага как цвет фона и тип флага как текст под каждой деревней.<br><br>Если деревне не назначен никакой флаг, она будет помечена следующим цветом",
		info38:"Показать уровень защиты на карте",
		info39:"Уровень",
		info40:"Уровень защиты отобразит следующий текст под каждой из ваших деревень",
		info41:"количество защитных юнитов (лучник, копейщик, мечник, тяжелая кавалерия, катапульта) в вашей деревне",
		info42:"индикатор уровня",
		info43:"Индикатор уровня",
		info44:"Индикатор уровня рассчитывается путем деления количества защитных юнитов или их очков ODA (дополнительные настройки) на значение, равное силе полной защитной деревни.",
		info45:"Рекомендуется использовать очки OD как метод расчета. Это лучше отражает силу ваших юнитов.",
		info46:"Следующие цвета представляют защитную силу вашей деревни",
		info47:"сила меньше 2 деревень",
		info48:"сила между 2 и 3 деревнями",
		info49:"сила между 3 и 4 деревнями",
		info50:"сила между 4 и 5 деревнями",
		info51:"сила между 5 и 6 деревнями",
		info52:"сила больше 6 деревень",
		info53:"Защита",
		info54:"Атака",
		info55:"Защиты",
		info56:"Атаки",
		info57:"Показать уровень атаки на карте",
		info58:"Показать бонусные деревни на карте",
		info59:"Бонусные деревни",
		info60:"Скрипт покажет тип бонуса каждой бонусной деревни, упоминая здание, которое влияет (например, конюшня)",
		info61:"количество атакующих юнитов (топор, легкая кавалерия, тяжелая кавалерия, конный лучник, таран) в вашей деревне",
		info62:"Уровень атаки отобразит следующий текст под каждой из ваших деревень",
		info63:"Подробнее в Дополнительных настройках",
		info64:"количество снобов в каждой деревне",
	...
	buttons:{
		lang_open:"Открыть выбор языка",
			  ...
			  efarmogi:"Применить шаблон",
			  diagrafi:"Удалить данные",
	},
	notes:{
		diagrafi:"Сохраненные данные Карты успешно удалены из вашего localStorage.<br><br> Страница будет автоматически обновлена через 4 секунды.",
		protupo:"Не обнаружен выбранный шаблон настроек.<br><br> Выберите шаблон и попробуйте снова.",
	},
};
...
var lang_img='';
        ...
        else if (lang=="russian") {lang_img ='<img height="20px" style="cursor:help;" title="Russian" width="30px" src="https://upload.wikimedia.org/wikipedia/en/f/f3/Flag_of_Russia.svg">';}
...
$("head").append(tsaldiamorfwsi+tsalbody+tsalscript);    
	...
	var tsalkaponecell = "";
	tsalkaponecell+='<div class="target-select clearfix vis float_left"><h4><font color=darkgreen><center>'+tsalkapone_trans.general.tsalkapone_buttons+'</center></font></h4><table class="vis" style="width: 100%"><tbody>';
...
tsalkaponecell+='<input type="radio"  name="language" value="russian" id="russian_lang" checked><img height="20px" style="cursor:help;" title="Russian" width="30px" src="https://upload.wikimedia.org/wikipedia/en/f/f3/Flag_of_Russia.svg"><br>';
...
$.post(ScriptAPI.url,script);
	   ...
	   else  if (get_lang == "russian") {document.getElementById('russian_lang').checked = true; }
...
location.reload();
      ...
      $("#russian_lang").click(function(){
	localStorage.setItem("map_info_lang","russian");
location.reload();
    });
