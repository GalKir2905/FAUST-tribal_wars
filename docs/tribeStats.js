...
if (typeof customNames == 'undefined') {
    ...
    html += `<table class="vis" id="tableMembers" border="1" style="width: 100%"><tr><th>Имя игрока</th></tr>`;
                                ...
                                () => {
                                    ...
                                    $.getAll(linksGathering, (i, data) => {
                                        if ($(data).find(".lit-item")[3] != undefined) {
                                            ...
                                            gatheredperPlayer.push(["0", "Никогда"]);
                                        }
                                            ...
                                            for (var o = rowStart; o < gatheredperPlayer.length + rowStart; o++) {
                                                ...
                                                if (statsEnabled["Loot"] == true && statsEnabled["Gathering"] == true) {
                                                    ...
                                                    if (statsEnabled["Combined"] == true)
                                                        $(tribeTable + " tr").eq(o).append("<td>Нужно включить «Награблено» и «Собрано», чтобы увидеть этот столбец</td>")
                                                }
                                            }
                                            // ODA total
...
html += `</tr></table><input type="button" class="btn btnSophie" id="getData" onclick="getData()" value="Получить данные"><br>`;
