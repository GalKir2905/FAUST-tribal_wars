    ...
    <table class="vis" border="1" style="width: 100%;background-color:${backgroundColor};border-color:${borderColor}; margin-top:5px;">
        <tbody>
            ...
            <tr>
                ...
                <td style="background-color:${backgroundColor}; padding:4px; text-align:center;"><input type="number" id="repeatIntervalMin" min="1" value="60" style="width:20px; text-align:center;"></td>
                <td style="background-color:${backgroundColor}; padding:4px; text-align:center;"><input type="number" id="repeatIntervalMax" min="1" value="60" style="width:20px; text-align:center;"></td>
                <td style="background-color:${backgroundColor}; padding:4px; color:${titleColor}; font-size:12px;">Количество</td>
                <td style="background-color:${backgroundColor}; padding:4px; text-align:center;"><input type="number" id="repeatCount" min="1" value="5" style="width:20px; text-align:center;"></td>
            </tr>
        </tbody>
    </table>
